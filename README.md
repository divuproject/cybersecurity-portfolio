...
**Master of Science in Cybersecurity** *(2024 – 2026)*
LJ University, Ahmedabad, India

**Bachelor of Computer Applications (BCA)** *(2021 – 2024)*
Veer Narmad South Gujarat University (VNSGU), Surat, India
**SGPA:** 8.01
...
* **Networking Tools:** Wireshark, Nmap, Cisco Packet Tracer, Burp Suite
* **Forensics & Security Tools:** Kali Linux, Metasploit, FTK Imager, Volatility

### 💻 Programming & Databases

* **Languages:** Python, C, Java (Basic–Intermediate)
* **Database:** SQL, MySQL
...
* Developed a proof-of-concept Android malware simulation framework for educational and defensive research.
* Demonstrated how malicious applications can exfiltrate sensitive user data including call logs, SMS, contacts, photos, videos, audio recordings, and location information.
* Simulated real-world attack vectors using cloud-based APIs in a controlled environment.
* Focused on Android permission abuse, mobile security risks, and cybersecurity awareness.
...
* Penetration Testing, Threat Hunting, Cryptography – Coursera
